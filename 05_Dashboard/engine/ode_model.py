...
# Factor de capacidad aguas abajo con 1 sola bola activa (Regla 9). Sin dato
# calibrado confirmado — supuesto documentado en 04_Reports/Technical/
# 20260714_Logica_Operacional_Pilas_SAG.md; parametrizable, no hardcodeado
# en el kernel (engine/circuit_state.py::calculate_effective_sag_rate).
